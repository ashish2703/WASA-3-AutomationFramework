...
public class vtiger2 {
	...
	public static void main(String[] args) {
		...
		//Step 4:Click on Create Organizations Lookup Image
		driver.findElement(By.xpath("//img[@title='Create Organization...']")).click();
		
		
		//Step 5:Create Organization for mandatory Fields
		driver.findElement(By.xpath("//input[@name='accountname']")).sendKeys("ashu238");
		driver.findElement(By.xpath("//input[@title='Save [Alt+S]']")).click();
		
		
		//Step 6:Save and Verify
		String verify = driver.findElement(By.xpath("//span[@class='dvHeaderText']")).getText();
		if(verify.contains("ashu238"))
				{
